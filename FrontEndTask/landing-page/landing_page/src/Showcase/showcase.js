    ...
    <section className="showcase">
      <div className="container-fluid p-0">
        <div className="row g-0">
          <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/img/bg-masthead.jpg)` }}></div>
        ...
        <div className="row g-0">
          <div className="col-lg-6 text-white showcase-img" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/img/bg-showcase-2.jpg)` }}></div>
        ...
        <div className="row g-0">
          <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/img/bg-showcase-3.jpg)` }}></div>
          <div className="col-lg-6 order-lg-1 my-auto showcase-text">
